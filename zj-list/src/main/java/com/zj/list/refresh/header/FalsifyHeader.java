...
/**
 * 虚假的 Header
 * 用于 正真的 Header 在 RefreshLayoutIn 外部时，
 * 使用本虚假的 FalsifyHeader 填充在 RefreshLayoutIn 内部
 * 具体使用方法 参考 纸飞机（FlyRefreshHeader）
 * Created by ZJJ  on 2017/6/14.
 */
...
public class FalsifyHeader extends InternalAbstract implements RefreshHeader {
    ...
    @Override
    public void onReleased(@NonNull RefreshLayoutIn layout, int height, int maxDragHeight) {
