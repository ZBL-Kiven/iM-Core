...
import static com.zj.list.refresh.util.SmartUtil.getColor;
...
public abstract class InternalClassics<T extends InternalClassics> extends InternalAbstract implements RefreshInternal {
    ...
    @Override
    public void onStartAnimator(@NonNull RefreshLayoutIn refreshLayoutIn, int height, int maxDragHeight) {
        final View progressView = mProgressView;
    ...
    @Override
    public void onReleased(@NonNull RefreshLayoutIn refreshLayoutIn, int height, int maxDragHeight) {
        onStartAnimator(refreshLayoutIn, height, maxDragHeight);
    }
     ...
     */
    @Override
    public int onFinish(@NonNull RefreshLayoutIn refreshLayoutIn, boolean success) {
        final View progressView = mProgressView;
        Drawable drawable = mProgressView.getDrawable();
        if (drawable instanceof Animatable) {
            if (((Animatable) drawable).isRunning()) {
