...
import com.zj.list.refresh.internal.ArrowDrawable;
import com.zj.list.refresh.internal.InternalClassics;
import com.zj.list.refresh.internal.ProgressDrawable;
...
//    }
    ...
    public void onStartAnimator(@NonNull RefreshLayoutIn refreshLayoutIn, int height, int maxDragHeight) {
        if (!mNoMoreData) {
            super.onStartAnimator(refreshLayoutIn, height, maxDragHeight);
        }
    }
