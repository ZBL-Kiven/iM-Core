...
import com.zj.list.refresh.interfaces.RefreshContent;
...
import com.zj.list.refresh.util.DesignUtil;
...
import static com.zj.list.refresh.util.ScrollBoundaryUtil.*;
