package com.zj.imcore.utils.img.transactions
...
class RoundCorner constructor(context: Context, leftTop: Float = 0f, rightTop: Float = 0f, rightBottom: Float = 0f, leftBottom: Float = 0f) : BitmapTransformation() {

    private val mId: String = "$leftTop$rightTop$leftBottom$rightBottom"
    ...
    init {
        bytes = mId.toByteArray(Key.CHARSET)
    }
    ...
    override fun hashCode(): Int {
        return mId.hashCode() + leftTop.hashCode() + rightTop.hashCode() + leftBottom.hashCode() + rightBottom.hashCode()
    }
