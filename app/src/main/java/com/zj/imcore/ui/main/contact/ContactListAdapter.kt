...
class ContactListAdapter(val context: Context) : GroupedListAdapter<MemberBean, ContactGroupInfo>(context) {
    ...
    override fun bindChild(holder: BaseViewHolder?, r: MemberBean, pos: Int) {
        ...
        holder?.setText(R.id.app_fragment_contact_item_tv_title, r.title ?: "null")
    }
