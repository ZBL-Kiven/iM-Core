...
package com.zj.preview.downloader.database;
...
public class AppDbHelper implements DbHelper {
    ...
    public DownloadModel find(int id) {
        ...
        try (Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE " +
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                model.setETag(cursor.getString(cursor.getColumnIndex(DownloadModel.E_TAG)));
    ...
    public void insert(DownloadModel model) {
        try {
            ...
            values.put(DownloadModel.E_TAG, model.getETag());
