...
package com.zj.preview.downloader.internal;

import com.zj.preview.downloader.Constants;
import com.zj.preview.downloader.Error;
import com.zj.preview.downloader.Progress;
import com.zj.preview.downloader.Response;
import com.zj.preview.downloader.Status;
import com.zj.preview.downloader.database.DownloadModel;
import com.zj.preview.downloader.handler.ProgressHandler;
import com.zj.preview.downloader.httpclient.HttpClient;
import com.zj.preview.downloader.internal.stream.FileDownloadOutputStream;
import com.zj.preview.downloader.internal.stream.FileDownloadRandomAccessFile;
import com.zj.preview.downloader.request.DownloadRequest;
import com.zj.preview.downloader.utils.Utils;
...
class DownloadTask {
    ...
    Response run() {
        ...
        try {
            ...
            eTag = httpClient.getResponseHeader(Constants.TAG);
    ...
    private void sendProgress() {
        if (request.getStatus() != Status.CANCELLED) {
            if (progressHandler != null) {
                progressHandler.obtainMessage(Constants.UPDATE, new Progress(request.getDownloadedBytes(), totalBytes)).sendToTarget();
            }
        }
    }
