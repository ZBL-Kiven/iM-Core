 ...
 */
internal class PreviewBaseLoadingView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr) {
    ...
    private val listener = object : BaseLoadingAnimatorListener {
        ...
        override fun onDurationChange(animation: ValueAnimator, duration: Float, mode: DisplayMode?, isShowOnAct: Boolean) {
            synchronized(this@PreviewBaseLoadingView) {
    ...
    fun setRefreshListener(refresh: () -> Unit) {
        ...
        setOnClickListener {
            if (refreshEnable && refreshEnableWithView && this@PreviewBaseLoadingView.refresh != null) {
                this@PreviewBaseLoadingView.refresh?.invoke()
            }
        }
    }
    ...
    private fun initView(context: Context) {
        contentView = View.inflate(context, R.layout.conversation_preview_loading_view, this)
     ...
     */
    fun setLoadingDrawable(drawableRes: Int): PreviewBaseLoadingView {
        this.loadingRes = drawableRes
        return this
    }

    //call resetUi() after set this
    fun setNoDataDrawable(drawableRes: Int): PreviewBaseLoadingView {
        this.noDataRes = drawableRes
        return this
    }

    //call resetUi() after set this
    fun setNetErrorDrawable(drawableRes: Int): PreviewBaseLoadingView {
