 ...
 * */
internal class PageAdapter<T : Any?>(private val resId: Int,private val context: Context?, private var adapter: OnPageChange<T>?) : PagerAdapter(), ViewPager.OnPageChangeListener {
    ...
    private fun <T : Any?> getPointIndexItem(collection: List<T>?, index: Int): T? {
